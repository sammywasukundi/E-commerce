...
//     var options = {
//         types: ['geocode'] // Permet uniquement les adresses
//     };

//     var autocomplete = new google.maps.places.Autocomplete(input, options);
// });

// animations des divisions

ScrollReveal().reveal('#image',{delay:200,distance : '80px',duration : 4000,reset : true, origin:'left'});
