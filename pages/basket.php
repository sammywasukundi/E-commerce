                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <img src="img_produits/<?= $select['img_produit']; ?>" class="w-14 h-12 object-cover"
                                        alt="">
                                </th>
                                <td class="px-6 py-4"><?= $select['nom']; ?></td>
                                <td class="px-6 py-4">
                                    <input class="w-14 border-0 focus:ring-0" type="text"
                                        value="<?= $_SESSION['panier'][$select['id_produit']] ?>"
                                        name="panier[qte][<?= $select['id_produit']; ?>]">
                                </td>
                        ...
                        <td class="px-6 py-4">
                            <button type="submit">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    class="w-9 h-9 text-gray-600 hover:text-gray-800">
